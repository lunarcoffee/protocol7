...
export const Hoverable = ({ glow = true, children }: HoverableProps) => (
  <div className="relative h-full rounded-xs group hover:ring ring-aero-tint-darkest/80 hover:inset-shadow-[0_2px_6px] hover:inset-shadow-white/30 transition duration-100">
    {glow && (
